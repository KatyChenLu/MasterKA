...
@interface MasterNotificationView () <TWMessageViewDelegate>
...
@implementation MasterNotificationView

#pragma mark - Singleton

+ (MasterNotificationView *)sharedInstance
{
    static dispatch_once_t pred;
    static MasterNotificationView *instance = nil;
    dispatch_once(&pred, ^{
...
{
    [self showMessageWithTitle:title description:description type:type duration:[MasterNotificationView durationForMessageType:type] callback:nil];
}
...
{
    [self showMessageWithTitle:title description:description type:type duration:[MasterNotificationView durationForMessageType:type] callback:callback];
}
...
{
    [self showMessageWithTitle:title description:description type:type duration:[MasterNotificationView durationForMessageType:type] statusBarHidden:statusBarHidden statusBarStyle:UIStatusBarStyleDefault callback:callback];
}
...
+ (void)initialize
{
    if (self == [TWMessageView class])
    {
        ...
        // Colors
        kTWMessageViewTitleColor = [UIColor colorWithWhite:0.0 alpha:1.0];
        kTWMessageViewDescriptionColor = [UIColor colorWithWhite:0.0 alpha:1.0];
    }
}
...
- (CGFloat)height
{
    CGSize titleLabelSize = [self titleSize];
    CGSize descriptionLabelSize = [self descriptionSize];
    CGFloat maxHeight = MAX((kTWMessageViewBarPadding * 2) + titleLabelSize.height + descriptionLabelSize.height + [self statusBarOffset], (kTWMessageViewBarPadding * 2) + kTWMessageViewIconSize + [self statusBarOffset]);
    return maxHeight;
}
...
//        kTWDefaultMessageBarStyleSheetInfoBackgroundColor = [UIColor colorWithRed:0.0 green:0.482 blue:1.0 alpha:kTWMessageBarStyleSheetMessageBarAlpha]; // blue
        kTWDefaultMessageBarStyleSheetInfoBackgroundColor =[UIColor colorWithRed:255/255.0f green:227/255.0f blue:38/255.0f alpha:kTWMessageBarStyleSheetMessageBarAlpha];
