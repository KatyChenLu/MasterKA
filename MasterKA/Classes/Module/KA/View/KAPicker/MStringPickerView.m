...
@interface MStringPickerView()<UIPickerViewDelegate,UIPickerViewDataSource>
...
@property (nonatomic, copy) MStringPickerBlock resultBlock;
// 单列选中的项
...
@implementation MStringPickerView
...
+ (void)showStringPickerWithTitle:(NSString *)title
    ...
    MStringPickerView *strPickerView = [[MStringPickerView alloc]initWithTitle:title dataSource:dataSource defaultSelValue:defaultSelValue isAutoSelect:isAutoSelect resultBlock:resultBlock];
...
- (UIPickerView *)pickerView {
    if (!_pickerView) {
        _pickerView = [[UIPickerView alloc]initWithFrame:CGRectMake(0, kTopViewHeight + 0.5, ScreenWidth, kDatePicHeight)];
