...
- (void)createMainView
{
    _minLabel = [[UILabel alloc]initWithFrame:CGRectMake(0, 10, (self.width-10)/2, 40)];
    _maxLabel = [[UILabel alloc]initWithFrame:CGRectMake(self.width/2+5, 10 ,(self.width-10)/2, 40)];
...
//    _maxLabel.adjustsFontSizeToFitWidth = YES;
    UILabel *midLabel = [[UILabel alloc] initWithFrame:CGRectMake(self.width/2-5, 10, 5, 40)];
    midLabel.text = @"~";
    ...
    UIButton *minSliderButton = [[UIButton alloc]initWithFrame:CGRectMake(0,sliderOffY + 10, 24, 24)];
    [minSliderButton setImage:[UIImage imageNamed:@"sliderBtn"] forState:UIControlStateNormal];
...
//    minSliderButton.layer.borderWidth = 0.5;
    ...
    UIButton *maxSliderButton = [[UIButton alloc]initWithFrame:CGRectMake(self.width-24, sliderOffY + 10, 24, 24)];
    [maxSliderButton setImage:[UIImage imageNamed:@"sliderBtn"] forState:UIControlStateNormal];
...
{
    _minLabel.text = [NSString stringWithFormat:@"%@%d",_unit,(int)(_minNum + (_tatol * (num-20.0)))];
    _currentMinValue = _minNum + (_tatol * (num-20.0));
}

- (void)valueMaxChange:(CGFloat)num
{
    _maxLabel.text = [NSString stringWithFormat:@"%@%d",_unit,(int)(_minNum +(_tatol * (num-20.0)))];
...
-(void)setMinNum:(CGFloat)minNum
{
    ...
    _minLabel.text = [NSString stringWithFormat:@"%@%d",_unit,(int)minNum];
...
-(void)setMaxNum:(CGFloat)maxNum
{
    ...
    _maxLabel.text = [NSString stringWithFormat:@"%@%d",_unit,(int)maxNum];
