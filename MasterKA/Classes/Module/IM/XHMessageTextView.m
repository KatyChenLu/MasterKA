...
- (void)layoutSubviews{
    ...
    }else if(frame.size.height<self.contentSize.height && frame.size.height<200){
...
- (void)drawRect:(CGRect)rect
{
    ...
    if([self.text length] == 0 && self.textStorage.length==0 && self.placeHolder) {
        ...
        if (NSFoundationVersionNumber > NSFoundationVersionNumber_iOS_7_0) {
            ...
            if (self.placeImg) {
                placeHolderRect = CGRectMake(35.0f,
                                             7.0f,
                                             rect.size.width,
                                             rect.size.height);
                [self.placeImg drawInRect:CGRectMake(10, 7.0f, 18, 18)];
            }
