...
#define ksendBtnMinWidth 46
#define ksendBtnMinHeight 28
 ...
 *  是否显示录音按钮
 */
@property (nonatomic)BOOL styleChangeButtonShow;

/**
 *  是否显示表情按钮
 */
@property (nonatomic)BOOL faceButtonShow;

/**
 *  是否拍照按钮
 */
@property (nonatomic)BOOL imageButtonShow;


/**
 *  是否发送按钮
 */
@property (nonatomic)BOOL sendButtonShow;
