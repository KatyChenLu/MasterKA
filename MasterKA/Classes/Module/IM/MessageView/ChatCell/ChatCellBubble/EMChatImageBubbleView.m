...
//            image = [UIImage imageNamed:@"imageDownloadFail.png"];
            [self.imageView setImageWithURLString:model.imageRemoteURL placeholderImage:[UIImage imageNamed:@"imageDownloadFail.png"]];
            dispatch_time_t delayTime = dispatch_time(DISPATCH_TIME_NOW, (int64_t)(0.8/*延迟执行时间*/ * NSEC_PER_SEC));
            dispatch_after(delayTime, dispatch_get_main_queue(), ^{
                [self.imageView  setCanBrowser:YES];
                self.imageView .browserImages = @[[model.imageRemoteURL masterFullImageUrl]];
            });
