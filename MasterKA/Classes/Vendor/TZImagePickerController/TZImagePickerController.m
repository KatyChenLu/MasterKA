...
//    self.navigationBar.barStyle = UIBarStyleBlack;
    ...
    if (iOS7Later) {
        ...
        self.navigationBar.tintColor = MasterDefaultColor;
        self.automaticallyAdjustsScrollViewInsets = NO;
    }
}

- (void)setNaviBgColor:(UIColor *)naviBgColor {
    _naviBgColor = MasterDefaultColor;
    self.navigationBar.barTintColor = naviBgColor;
}

- (void)setNaviTitleColor:(UIColor *)naviTitleColor {
    _naviTitleColor = [UIColor blackColor];
...
- (void)setBarItemTextColor:(UIColor *)barItemTextColor {
    _barItemTextColor = [UIColor blackColor];
    [self configBarButtonItemAppearance];
}
...
- (void)pushViewController:(UIViewController *)viewController animated:(BOOL)animated {
    ...
    if (self.childViewControllers.count > 0) {
        ...
        [backButton setImage:[[UIImage imageNamedFromMyBundle:@"navi_back.png"] imageWithTintColor:[UIColor blackColor]] forState:UIControlStateNormal];
