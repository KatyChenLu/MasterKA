...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.imageView.canBrowser = self.canBorwser;
    cell.imageView.browserImages = self.imagePathsGroup;
    if ([imagePath isKindOfClass:[NSString class]]) {
        if ([imagePath hasPrefix:@"http"] || [imagePath hasPrefix:@"uploadfile"]) {
            [cell.imageView setImageWithURLString:imagePath placeholderImage:self.placeholderImage];
        } else {
    ...
    cell.imageView.cornerRadius = 8.0f;
    cell.imageView.masksToBounds = YES;
