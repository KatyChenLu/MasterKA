...
#define APP_ID          @"wx00d2ac16fd629e08"               //APPID
#define APP_SECRET      @"f7ac824dce38e6936ef4579beb0eb81e" //appsecret
//商户号，填写商户对应参数
#define MCH_ID          @"1241157802"
//商户API密钥，填写相应参数
#define PARTNER_ID      PartnerPrivKey
//支付结果回调页面
