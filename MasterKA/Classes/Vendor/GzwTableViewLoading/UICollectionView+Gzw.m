...
@implementation UICollectionView (Gzw)
...
{
    objc_setAssociatedObject(self, &blockCollection, loadingClick, OBJC_ASSOCIATION_COPY_NONATOMIC);
}
...
-(void (^)())loadingClick
{
    return objc_getAssociatedObject(self, &blockCollection);
}
...
- (UIImage *)imageForEmptyDataSet:(UIScrollView *)scrollView
{
    if (self.loading) {
        ...
        return [[UIImage imageNamed:imageName] imageWithTintColor:[UIColor lightGrayColor]];
    }
}
