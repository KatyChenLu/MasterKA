//
//  UILabel+MasterFont.m
//  MasterKA
//
//  Created by jinghao on 16/6/13.
//  Copyright © 2016年 jinghao. All rights reserved.
//

#import "UILabel+MasterFont.h"
#import <objc/runtime.h>
@implementation UILabel (MasterFont)
+(void)load{
    //只执行一次这个方法
...
- (instancetype)YHBaseInit
{
    ...
    UIFont * font = [UIFont fontWithName:SpecialFont size:self.font.pointSize];
    if (font) {
        self.font=font;
    }
    return __self;
